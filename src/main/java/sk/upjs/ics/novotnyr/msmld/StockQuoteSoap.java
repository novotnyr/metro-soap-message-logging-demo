...
public interface StockQuoteSoap {
    ...
    @RequestWrapper(localName = "GetQuote", targetNamespace = "http://www.webserviceX.NET/", className = "sk.upjs.ics.novotnyr.msmld.GetQuote")
    @ResponseWrapper(localName = "GetQuoteResponse", targetNamespace = "http://www.webserviceX.NET/", className = "sk.upjs.ics.novotnyr.msmld.GetQuoteResponse")
